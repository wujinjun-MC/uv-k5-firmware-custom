...
ENABLE_TURN ?=1
# MOD
ENABLE_LONGER_TX_TIMEOUT 		  ?= 1
# MOD
ENABLE_LONGER_VOX_TIMEOUT 		  ?= 1
ENABLE_SCANNER_SAVE_TXCTCSS_TXDCS_ONLY 		  ?= 1
ENABLE_NARROW_BANDWIDTH_NARROWER 		  ?= 1
# ---- DEBUGGING ----
...
ENABLE_MESSENGER_CTCSS_DCS			= 1
ENABLE_4732 =0
ENABLE_4732SSB =0

ENABLE_DOPPLER               =0
#############################################################
PACKED_FILE_SUFFIX = LOSEHU133
...
ifeq ($(ENABLE_LONGER_TX_TIMEOUT),1)
	CFLAGS += -DENABLE_LONGER_TX_TIMEOUT
endif
ifeq ($(ENABLE_LONGER_VOX_TIMEOUT),1)
	CFLAGS += -DENABLE_LONGER_VOX_TIMEOUT
endif
ifeq ($(ENABLE_SCANNER_SAVE_TXCTCSS_TXDCS_ONLY),1)
	CFLAGS += -DENABLE_SCANNER_SAVE_TXCTCSS_TXDCS_ONLY
endif
ifeq ($(ENABLE_NARROW_BANDWIDTH_NARROWER),1)
	CFLAGS += -DENABLE_NARROW_BANDWIDTH_NARROWER
endif
...
ifeq ($(ENABLE_MESSENGER_CTCSS_DCS),1)
	CFLAGS += -DENABLE_MESSENGER_CTCSS_DCS
endif
#ifeq ($(ENABLE_CHINESE_FULL),4)
...
full:
	...
	$(MAKE) build ENABLE_CHINESE_FULL=4 ENABLE_ENGLISH=1 ENABLE_SPECTRUM=1 ENABLE_FMRADIO=1 ENABLE_MDC1200=1 ENABLE_MDC1200_EDIT=1 ENABLE_MDC1200_CONTACT=1
	$(MAKE) build ENABLE_CHINESE_FULL=0 ENABLE_SPECTRUM=1 ENABLE_FMRADIO=1
	$(MAKE) build ENABLE_CHINESE_FULL=4 ENABLE_SPECTRUM=1 ENABLE_FMRADIO=1 ENABLE_MDC1200=1 ENABLE_MDC1200_EDIT=1 ENABLE_MDC1200_CONTACT=1
	$(MAKE) build ENABLE_CHINESE_FULL=4 ENABLE_PINYIN=1 ENABLE_SPECTRUM=1 ENABLE_FMRADIO=1
	$(MAKE) build ENABLE_CHINESE_FULL=4 ENABLE_PINYIN=1 ENABLE_4732=1 ENABLE_4732SSB=0
